...
- This scenario is not a long article. It needs a result-first product board and one practical decision page.
- Two cards are enough to prove Lookbook Journal can handle non-fashion objects without becoming a dry spec sheet.
...
- System: Lookbook Journal
- Board: Xiaohongshu 1080x1440
- Template status: `gold-reference`
- Purpose: prove product/gear/food breakdown can use the same result-first, callout-heavy language as outfit cards.

## Acceptance

- Uses a central raster product image, not CSS or SVG placeholder art.
- Product result is large enough to inspect.
- Copy tells users what to buy and why, without pretending to be a full buyer's guide.
